...
execute-query-and-display-results = do ->
    ...
    ({server-name, database, collection, parameters, query, transformation, presentation, multi-query, type}:document-state)->
        ...
        err, result <- execute-query query, parameters, server-name, database, collection, multi-query, type, cache
